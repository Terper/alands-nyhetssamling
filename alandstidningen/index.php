...
<head>
    ...
    <title>Ålands Nyhetssamling | Ålandstidningen</title>
    ...
    <div class="w3-row">
        ...
        <div class="w3-col l8">
            ...
            <div class="w3-bar w3-yellow w3-large w3-bar">
                ...
                <a href="/~jannt/dev/alands-nyhetssamling/alandsradio" class="w3-bar-item w3-button w3-hover-red w3-hide-small">Ålands Radio</a>
                <a href="/~jannt/dev/alands-nyhetssamling/alandstidningen" class="w3-bar-item w3-button w3-hover-red w3-hide-small w3-red">Ålandstidningen</a>
            ...
            <div id="respnav" class="w3-bar-block w3-yellow w3-hide w3-hide-large w3-hide-medium w3-large">
                <a href="/~jannt/dev/alands-nyhetssamling/alandsradio" class="w3-bar-item w3-button w3-hover-red">Ålands Radio</a>
                <a href="/~jannt/dev/alands-nyhetssamling/alandstidningen" class="w3-bar-item w3-button w3-hover-red w3-red">Ålandstidningen</a>
            ...
            <div>
                <?php
                    //Feed URLs
                    $feeds = array(
                        "https://alandstidningen.ax/rss/allt"
                    );
