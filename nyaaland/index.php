...
<head>
    ...
    <title>Ålands Nyhetssamling | Nya Åland</title>
    ...
    <div class="w3-row">
        ...
        <div class="w3-col l8">
            ...
            <div class="w3-bar w3-yellow w3-large w3-bar">
                ...
                <a href="/~jannt/dev/alands-nyhetssamling/nyaaland" class="w3-bar-item w3-button w3-hover-red w3-hide-small w3-red">Nya Åland</a>
            ...
            <div id="respnav" class="w3-bar-block w3-yellow w3-hide w3-hide-large w3-hide-medium w3-large">
                ...
                <a href="/~jannt/dev/alands-nyhetssamling/nyaaland" class="w3-bar-item w3-button w3-hover-red w3-red">Nya Åland</a>
            </div>
